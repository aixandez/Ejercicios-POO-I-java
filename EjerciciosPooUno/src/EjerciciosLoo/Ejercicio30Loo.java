/* 30. Escribir una función que reciba un arreglo de enteros y devuelva:
true si el arreglo está ordenado de mayor a menor y false si está desordenado. */

package EjerciciosLoo;

public class Ejercicio30Loo {
